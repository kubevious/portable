...
export class RoleHelper {
  ...
  buildRoleMatrix(rulesMap: RulesMap) {
    ...
    rows = _.orderBy(rows, ["api", "resource", "name"]);
...
function isAllNsRulePresent(
  allNsNamedMap: Record<string, Record<string, VerbsDict>>,
  item: RuleItem
) {
...
function isAllNsRulePresentInNamespace(
  allNsNamedMap: Record<string, Record<string, VerbsDict>>,
  ns: string,
  item: RuleItem
) {
